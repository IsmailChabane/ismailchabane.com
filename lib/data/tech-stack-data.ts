...
export const techCategories: TechCategory[] = [
  {
    ...
    skills: [
      {
        icon: <SiPostgresql className="text-blue-700 h-4 w-4 md:h-5 md:w-5 xl:h-6 xl:w-6" />,
        name: "PostgreSQL",
      ...
      {
        icon: <SiMysql className="text-blue-600 h-4 w-4 md:h-5 md:w-5 xl:h-6 xl:w-6" />,
        name: "MySQL",
      ...
      {
        icon: <SiPrisma className="text-blue-800 h-4 w-4 md:h-5 md:w-5 xl:h-6 xl:w-6" />,
        name: "Prisma",
  ...
  },
  {
    ...
    skills: [
      ...
      {
        icon: <SiExpress className="text-gray-700 h-4 w-4 md:h-5 md:w-5 xl:h-6 xl:w-6" />,
        name: "Express",
      ...
      {
        icon: <SiTrpc className="text-blue-600 h-4 w-4 md:h-5 md:w-5 xl:h-6 xl:w-6" />,
        name: "tRPC",
  ...
  },
  {
    ...
    skills: [
      ...
      {
        icon: <SiNextdotjs className="text-gray-900 h-4 w-4 md:h-5 md:w-5 xl:h-6 xl:w-6" />,
        name: "Next.js",
        description: "Production-ready React framework"
      },
      {
        icon: <SiTypescript className="text-blue-600 h-4 w-4 md:h-5 md:w-5 xl:h-6 xl:w-6" />,
        name: "TypeScript",
  ...
  },
  {
    ...
    skills: [
      ...
      {
        icon: <MdMobileScreenShare className="text-gray-900 h-4 w-4 md:h-5 md:w-5 xl:h-6 xl:w-6" />,
        name: "PWA",
